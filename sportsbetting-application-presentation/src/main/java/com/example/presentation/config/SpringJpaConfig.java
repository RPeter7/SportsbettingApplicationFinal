...
public class SpringJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.example.domain.entities");
    ...
    public DataSource dataSource() {
        ...
        dataSource.setPassword("asda1234");
        dataSource.setUrl("jdbc:mysql://localhost:3306/sportsbetting_rohberg_peter?createDatabaseIfNotExist=true&useSSL=false");
